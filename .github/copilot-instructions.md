...
- **Keep implementation bookkeeping out of the narrative** - omit details such as removed test invariants, internal string sizes, and temporary tool workarounds unless they materially help reviewers judge behavior, risk, or maintainability. Put the user-visible outcome and decision rationale first.
