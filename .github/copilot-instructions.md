...
- **Keep implementation bookkeeping out of the narrative** - omit details such as removed test invariants, internal string sizes, and temporary tool workarounds. Put the user-visible outcome and decision rationale first.
