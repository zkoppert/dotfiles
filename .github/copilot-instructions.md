...
- **Never request a Copilot review automatically**: Do not post `@copilot review` or use another mechanism that requests a Copilot review unless I explicitly ask for that review in the current conversation.
